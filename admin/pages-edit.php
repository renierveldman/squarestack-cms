...
<div class="flex min-h-screen">
    ...
    <aside class="w-64 bg-slate-900 text-white flex flex-col flex-shrink-0">
        ...
        <nav class="flex-1 p-4 space-y-1">
            ...
            <a href="<?= SITE_URL ?>/admin/pages.php" class="flex items-center gap-3 px-3 py-2 rounded-lg bg-slate-700 text-white text-sm font-medium"><i class="fa fa-file w-4"></i> Pages</a>
        ...
        <div class="flex-1 overflow-y-auto p-8 space-y-6">
            ...
            <div>
                ...
                <select name="template" id="page-template" onchange="this.form.submit()"
                    ...
                    <option value="blank" <?= ($page['template'] ?? '') === 'blank' ? 'selected' : '' ?>>Blank</option>
                </select>
            </div>
